...
export GITOPS_REPO_URL=https://github.com/chetna14manku-org/hby9fwa12-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-d5bzr.d5bzr.sandbox2792.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-d5bzr.d5bzr.sandbox2792.opentlc.com}
